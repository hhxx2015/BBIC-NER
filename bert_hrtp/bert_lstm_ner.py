...
from bert_hrtp import optimization
from bert_hrtp import tokenization
...
__all__ = ['__version__', 'NerProcessor', 'write_tokens', 'convert_single_example',
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            hook_dict['global_steps'] = tf.compat.v1.train.get_or_create_global_step()
...
def train(args):
    ...
    #     stinggg= "  Num examples = "+str(len(predict_examples))
    #     logger.info(stinggg)
    #     stinggg= "  Batch size = "+str(args['batch_size'])
    #     logger.info(stinggg)
    #
    ...
    #     from bert_hrtp import conlleval
